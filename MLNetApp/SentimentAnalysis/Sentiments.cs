...
namespace MLNetApp
{
    class Sentiments
    {
        const string _dataPath = @".\SentimentAnalysis\data\sentiment labelled sentences\imdb_labelled.txt";
        const string _testDataPath = @".\SentimentAnalysis\data\sentiment labelled sentences\yelp_labelled.txt";
